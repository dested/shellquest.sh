...
export class BrowserLayeredRenderer {
  ...
  constructor(
    ...
    this.container = new GroupRenderable('layered-renderer', {
      x: x,
      y: y,
      zIndex: 2,
      visible: true,
        ...
        if (topAlpha > 0 && bottomAlpha > 0) {
          ...
          if (colorDiff < 0.05 && topAlpha > 0.95 && bottomAlpha > 0.95) {
            ...
            layer.frameBuffer.setCell(
              ...
              BLOCK_CHARS.LOWER,
              bottomColor,
              RGBA.fromValues(0, 0, 0, topAlpha * 0.3),
            );
            ...
            layer.frameBuffer.setCell(
              ...
              BLOCK_CHARS.UPPER,
              topColor,
              RGBA.fromValues(0, 0, 0, bottomAlpha * 0.3),
            );
  ...
  renderSpriteLayer(
    ...
    for (const entity of entities) {
      ...
      if (
        relX >= -entity.width &&
        relX <= this.viewportWidth &&
        relY >= -entity.height &&
        relY <= this.viewportHeight
      ) {
