...
import {Entity, LayeredRenderer} from '../../examples/crawler-demo/tilemap/LayeredRenderer.ts';
import {TILE_SIZE, TileMap} from '../../examples/crawler-demo/tilemap/TileMap.ts';
import {Level} from '../../examples/crawler-demo/level.ts';
import {BrowserLayeredRenderer} from '../../examples/crawler-demo/tilemap/BrowserLayeredRenderer.ts';
import {measureText, renderFontToFrameBuffer} from '@core/ui/ascii.font.ts';
...
export class GameplayState extends BaseState {
  ...
  private createUI(): void {
    new DungeonCrawlerGame(this.stateContainer, this.renderer);
  }
...
class DungeonCrawlerGame {
  ...
  constructor(
    ...
    stateContainer.add(this.gameContainer);
